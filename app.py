...
channel_secret = '8d154fd9c9fd9e56790a2e12f9df0f42'
channel_access_token = 'qjX/pNPPt5otKAdfti1g9dnPf3XcVKy5xXoitoRHlJAPPzmnRFehLQyt7k0uiQFhPJvEkpSsz+JoGc/IEOEbglYobdUo3KrgMmkOjJFqPh6w7Z8ovRgIepeBBjaKFFqZOe0joRhitluesZGimol09AdB04t89/1O/w1cDnyilFU='
...
model = load_model('./model/Saved_model/VeryVeryBest_ResNet50_20231127_204650/H5Model_ResNet50_LastEpoch.h5')
# Other Message Type
...
def handle_content_message(event):
    ...
    dic = {0 : 'CBB', 1 : 'CBSD', 2 : 'CGM', 3 : 'CMD', 4 : 'Healthy'}
    # load the image
    ...
    if (yhat[0] == 0):
        label = "มีโอกาสที่จะเป็น โรคใบไหม้(cbb)" 
    elif (yhat[0] == 1):
        label = "มีโอกาสที่จะเป็น โรคแผลขีดสีน้ำตาล(cbsd)" 
    elif (yhat[0] == 2):
        label = "มีโอกาสที่จะเป็น (cgm)" 
    elif (yhat[0] == 3):
        label = "มีโอกาสที่จะเป็น โรคใบด่าง(cmd)" 
    elif (yhat[0] == 4):
        label = "ใบมันสำปะหลังนี้ไม่มีโรค(healthy)"
